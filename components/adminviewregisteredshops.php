...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/foodmall/css/adminviewregisteredshops.css">
</head>
        ...
        if(mysqli_num_rows($result)<=0){
            ?>
                <div id="no-items" align="center">
                    ...
                    <a href="http://localhost/foodmall/components/adminlandingpage.php" id="shop-now">No Registered Shops</a>
                </div>
            <?php
                }
                else{
        ...
        <td id="booking-details-td">
            ...
            <?php
               echo "<div class='product-spec1'>
                   <a href='http://localhost/foodmall/components/adminsuspendshops.php?id=$id' id='cancel-book'>Suspend shops</a>
                    </div>";
                ?>
            </td>
