...
<?php include ('../components/shopheader.php'); ?>
    ...
    <table id="booking-table">
        ...
        if(mysqli_num_rows($result)<=0){
            ?>
                <div id="no-items" align="center">
                    ...
                    <a href="http://localhost/foodmall/components/shoplandingpage.php" id="shop-now">No booking</a>
                </div>
            <?php
                }
                else{
        ...
        <td id="booking-image-td">
            ...
            $id=$row['product_id'];
			echo "
                <a href='http://localhost/foodmall/components/shop_view_product.php?id=$id'>
                ";
                ?>
            ...
            <?php
               echo "<div class='product-spec1'>
                   <a href='http://localhost/foodmall/components/shopcancelbooking.php?id=$id' id='cancel-book'>cancel booking</a>
                    </div>";
                ?>
            </td>
