...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="http://localhost/foodmall/css/adminlandingpage.css">
    </head>
    <body id="admin-body">
    ...
    <div id="admin-container">
            ...
            <a id="send-button" href="http://localhost/foodmall/components/send_notifications.php">Send Notifications</a>
        </div>
