...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/foodmall/css/adminviewbooking.css">
</head>
        ...
        if(mysqli_num_rows($result)<=0){
            ?>
                <div id="no-items" align="center">
                    ...
                    <a href="http://localhost/foodmall/components/adminlandingpage.php" id="shop-now">No item found</a>
                </div>
            <?php
                }
                else{
