...
if(isset($_POST['submit'])){
    ...
    header("Location: http://localhost/foodmall/components/sendmail.php"); 
}
?>
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="http://localhost/foodmall/css/send_notfications.css">
    </head>
