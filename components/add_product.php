...
if (isset($_POST['submit'])) {
    if(isset($_FILES["photo"]) && $_FILES["photo"]["error"] == 0){
       ...
       if(in_array($filetype, $allowed)){
           ...
           $target="../images/";
            $tar="http://localhost/foodmall/images/";
           if(file_exists($target. $filename)){
               ...
               $s=$tar.$filename;
               $sql="INSERT INTO product (product_name,product_category,product_quantity,product_seller,product_price,shop_id,product_details1,product_details2,product_details3,product_image,product_pincode) VALUES('$name','$category','$quantity','$shop_name','$price','$shop_id','$details1','$details2','$details3','$s','$pincode')";
...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="http://localhost/foodmall/css/add_product.css">
        <script>
