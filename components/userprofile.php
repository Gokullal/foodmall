    ...
    <body id="profile-body">
        ...
        <div id="profile-container">
          ...
          <div id="profile-details">
            ...
            <hr>
            <div id="change-links">
            <a href="http://localhost/foodmall/components/changepincode.php" id="change-pincode">change pincode </a>
            <a href="http://localhost/foodmall/components/changepassword.php"id="change-password">Change Password</a>
            </div>
