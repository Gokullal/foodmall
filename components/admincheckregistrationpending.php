...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/foodmall/css/registrationpending.css">
</head>
        ...
        if(mysqli_num_rows($result)<=0){
            ?>
                <div id="no-items" align="center">
                    ...
                    <a href="http://localhost/foodmall/components/adminlandingpage.php" id="shop-now">No Pending Shops</a>
                </div>
            <?php
                }
                else{
        ...
        <td id="booking-details-td">
            ...
            <?php
               echo "<div class='product-spec1'>
                   <a href='http://localhost/foodmall/components/adminacceptresgistration.php?id=$id' id='accept-book'>Accept</a>
                    </div>";
                ?>
            </td>
            <td id="booking-cancel-td">
            <?php
               echo "<div class='product-spec1'>
                   <a href='http://localhost/foodmall/components/adminremoveshops.php?id=$id' id='cancel-book'>Remove</a>
                    </div>";
                ?>
            </td>
